...
Use the shaded connector JAR `phoenix5-spark3-shaded-5.1.3.3.3.6.1-SNAPSHOT.jar` .
...
`/etc/hbase/conf:$(hbase mapredcp):phoenix5-spark3-shaded-5.1.3.3.3.6.1-SNAPSHOT.jar`
